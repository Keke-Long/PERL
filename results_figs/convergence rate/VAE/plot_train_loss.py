...
# 橘色 NN
ax.plot(Data_driven_data[:]*16*1.5, label="NN", color="#FFA500", linestyle='-', linewidth=1)

# 紫色 PINN
ax.plot(PINN_data[:]*100, label="PINN", color="#9933FF", linestyle=(1,(5,5)), linewidth=1.3)

# 蓝色 PERL
ax.plot(PERL_data[:]*16*1.5, label="PERL", color="#0073e6", linestyle=(1,(5,1)), linewidth=1.6)
